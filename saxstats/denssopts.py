...
def parse_arguments(parser):
    ...
    parser.add_argument("-D", "--D_symmetry", default=0, type=int, help="D symmetry")
    parser.add_argument("-D_steps","--D_steps", default=[3000,5000,7000,9000], type=int, nargs='+', help="List of steps for applying D averaging (default=3000,5000,7000,9000)")
    parser.add_argument("-D_axis", "--D_axis", default=1, type=int, help="D symmetry axis (options: 1, 2, or 3 corresponding to (long,medium,short) principal axes)")
    parser.add_argument("-O", "--O_symmetry", default=0, type=int, help="O symmetry")
    parser.add_argument("-O_steps","--O_steps", default=[3000,5000,7000,9000], type=int, nargs='+', help="List of steps for applying O averaging (default=3000,5000,7000,9000)")
    parser.add_argument("-O_axis", "--O_axis", default=1, type=int, help="O symmetry axis (options: 1, 2, or 3 corresponding to (long,medium,short) principal axes)")
